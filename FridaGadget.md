...
В зависимом плагине импортируйте API лениво. Не делайте `import frida_gadget_api` на уровне модуля: `FridaGadget` создает этот модуль только после своей загрузки, и если ваш плагин загрузится раньше чем fridagadget, то ваш плагин не сможет импортировать API fridagadget.
