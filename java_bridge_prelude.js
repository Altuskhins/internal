...
`;
  ...
  // src/java_bridge_prelude.ts
  globalThis.Java = frida_java_bridge_default;
  globalThis.__fridaJavaBridge = frida_java_bridge_default;
  try {
    const available = !!frida_java_bridge_default.available;
    globalThis.console.log(
      "[FridaGadget][prelude] frida-java-bridge loaded, Java.available=" + available
    );
  } catch (err) {
    globalThis.console.warn(
      "[FridaGadget][prelude] frida-java-bridge probe threw: " + String(err)
    );
  }
})();
